...
// app.post('/company-master', (req, res) => 
// {
//     if (req.body.key === "add") 
//     {
//         try 
...
//             var com_active_ind = req.body.com_active_ind;
//             var comp_login_id = req.body.comp_login_id;
    
//             var sqq = "select * from company_details where comp_name = '"+comp_name+"';";
...
//                     {
//                      console.log("alreadt exist '"+comp_name+"';")    
//                     }
//                     else
//                     {
//                         var sql = "insert into company_details (comp_code,comp_name,com_active_ind,comp_login_id) values ('"+comp_code+"','"+comp_name+"','"+com_active_ind+"','"+comp_login_id+"')";
...
//                                 if (err) 
//                                 {
//                                     console.error("query error 2 : "+ err);
//                                     return res.json("Error inserting order." +err );
//                                 }
//                                  else 
//                                 {
//                                     console.log("Insert successfully:", result);
//                                     return res.json( "Order inserted successfully.");
//                                }
//                             } 
//                             catch (error) 
//                             {
...
//         // var sql = "update company_details set (comp_code,comp_name,com_active_ind,comp_login_id where comp_id ='"+comp_id+"') values ('"+comp_code+"','"+comp_name+"','"+com_active_ind+"','"+comp_login_id+"')";

//         var sql= "update company_details set comp_code ='"+comp_code+"',comp_name = '"+comp_name+"',com_active_ind = '"+com_active_ind+"',comp_login_id = '"+comp_login_id+"' where comp_id = '"+comp_id+"';"
...
//                 return res.json("Error update order." +err );
//              } else 
//             {
//                 console.log("update successfully:", result);
//                 return res.json( "Order update successfully.");
//             }
//             } catch (error) 
//             {
//               console.log(error);  
